...
//           {/* Account - Desktop */}
//     <Link to="/login">
//         <button onClick={() => navigate("/login")} className="hidden items-center gap-2 bg-[#ff8200] text-white px-4 py-1 rounded-xl md:flex">
...
//     <Link to="/signup">
//         <button onClick={() => navigate("/signup")} className="hidden items-center gap-2 border border-[#ff8200] rounded-xl px-3 py-1 text-[#1F1F1F] hover:text-[#FF6A00] md:flex">
//             <span className="font-semibold">
//               Signup
//             </span>
//           </button>
...
//  <Link to="/login">
//         <button onClick={() => navigate("/login")} className="hidden items-center gap-2 text-[#1F1F1F] md:flex hover:text-[#FF6A00]  ">
//             <span className="font-semibold">
